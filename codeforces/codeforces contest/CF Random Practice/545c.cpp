...
//     if(id==n) return 0;
//     ll mx=0;
//     if(mp.count({pre,id})) return mp[{pre,id}];
//     if((a[id]-h[id])>pre) 
//         mx=1+fun(a[id],id+1);

//     if( id+1==n or ( id+1<n and (a[id]+h[id]) < a[id+1]))
//         mx=max(mx,1+fun(a[id]+h[id],id+1));

//     mx=max(mx,fun(a[id],id+1));
//     return mp[{pre,id}]=mx;
// }
// int main(){
//    // fin;
